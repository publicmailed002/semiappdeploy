            ...
            <div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-slate-600/30">
              <div className="w-full max-w-md">
                    ...
                    <div className='text-center mb-8'>
                       ...
                       <p className='text-slate-400'> Signup up for a new account</p>
                ...
                <div className='hidden md:w-1/2 md:flex items-center justify-center p-6 bg-linear-to-bl from-slate-800/20 to-transparent'>
                   <div>
                       ...
                       />
                       <div className='mt-6 text-center'>
                          <h3 className='text-xl font-medium text-cyan-400'> Start Your Joureny Today</h3>
